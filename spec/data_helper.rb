module DataHelper
  ...
  #   * value = Hash
  #     * :value              = Required Any. Value set with libkv::put()
  #     * :metadata           = Required Hash. Value set with likv::put()
  #     * :serialized_value   = Required String. String value persisted in the store.
  #                             It is generated by the libkv adapter from :value.
  #     * :deserialized_value = Optional String. Value restored by the libkv adapter
  ...
  def data_info
    ...
    data_info = {
      ...
      'malformed UTF-8 String' => {
        ...
        # correct encoding of ASCII-8BIT, as the libkv adapter 'fixes'
