...
shared_examples 'simpkv::get tests' do |host|
  ...
  context "simpkv::get operation on #{host}" do
    ...
    it 'should call simpkv::get for valid keys without errors and verify retrieved info' do
      set_hieradata_on(host, hieradata_with_valid_keys)
      apply_manifest_on(host, manifest, :catch_failures => true)
    end

    it 'should call simpkv::get with softfail=true for invalid keys without errors and verify nothing is retrieved' do
